...
#import "HCTimeTool.h"
@interface HCInvesetmentEarningCell ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UILabel *timeLabel;
@property (nonatomic, strong) UILabel *moneyLabel;
@end

@implementation HCInvesetmentEarningCell
...
- (void)setModel:(HCMyDealModel *)model {
    ...
    self.moneyLabel.text = [NSString stringWithFormat:@"%.2f元",[model.getProfit doubleValue]];
}
- (void)layout_Masonry {
